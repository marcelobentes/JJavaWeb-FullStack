...
public class AlunoTest {
	...
	public static void main(String[] args) {
		...
		String nota2 = JOptionPane.showInputDialog("Informe o nota1: ");
		String nota3 = JOptionPane.showInputDialog("Informe o nota1: ");
		String nota4 = JOptionPane.showInputDialog("Informe o nota1: ");
		...
		aluno2.setNota1(Double.valueOf(nota1));
		aluno2.setNota2(Double.valueOf(nota2));
		aluno2.setNota3(Double.valueOf(nota3));
		aluno2.setNota4(Double.valueOf(nota4));
